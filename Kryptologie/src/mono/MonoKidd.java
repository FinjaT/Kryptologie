...
public class MonoKidd {
	...
	public static void main(String[] args) {
		...
		String cipher =				
				  ...
				  + "#?;";
		System.out.println(cipher.charAt(1)); //liefert das Zeichen an Postion 1 in cipher (=3)
		System.out.println(cipher.length()); //liefert die Länge des Strings cipher(=203)
